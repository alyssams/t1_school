require([
    ...
    html_editor.setValue('<h1>Click on the HTML and CSS areas on the left and start coding.</h1>');
    css_editor.setValue('h1 { font-family: arial; color: blue; text-align: center; font-size: 28px;}');
