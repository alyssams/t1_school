...
(function () {
    ...
    var modeAtxNoSpace = CodeMirror.getMode({
        tabSize: 4
    }, {
        name: "markdown",
    ...
    var modeFenced = CodeMirror.getMode({
        tabSize: 4
    }, {
        name: "markdown",
    ...
    function FencedTest(name) {
        test.mode(name, modeFenced, Array.prototype.slice.call(arguments, 1));
    }
    ...
    var modeFormattingOverride = CodeMirror.getMode({
        tabsize: 4
    }, {
        name: "markdown",
        highlightFormatting: true,
